...
describe('Testing the string functions', function () {
  ...
  it('lasso.between: Returns a string between 2 characters', function () {
    ...
    capture[0].should.eql('(between)');
    capture[1].should.eql('between');
  });
  ...
  it('lasso ellipsis: return ellipsis text (less than length)', function () {
    lasso.ellipsis('this is short', 20).should.eql('this is short');
  });
